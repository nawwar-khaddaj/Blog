    ...
    <div class="offcanvas-content pr-5 mr-n5">
        <div class="row gutter-b">
            ...
            <div class="col-6">
                <a href="#" class="btn btn-block btn-light btn-hover-primary text-dark-50 text-center py-10 px-5">
                    <span class="svg-icon svg-icon-3x svg-icon-primary m-0">
                        {{ AdminPanel::getSVG("media/svg/icons/Shopping/Box2.svg", "svg-icon-xl") }}
                    </span>
                    <span class="d-block font-weight-bold font-size-h6 mt-2">Sections</span>
                </a>
            </div>
            <!--end::Item-->
            <!--begin::Item-->
            <div class="col-6">
                <a href="#" class="btn btn-block btn-light btn-hover-primary text-dark-50 text-center py-10 px-5">
                    <span class="svg-icon svg-icon-3x svg-icon-primary m-0">
                        {{ AdminPanel::getSVG("media/svg/icons/Shopping/Chart-bar1.svg", "svg-icon-xl") }}
                    </span>
                    <span class="d-block font-weight-bold font-size-h6 mt-2">Tests</span>
                </a>
            </div>
            <!--end::Item-->
        </div>
        <div class="row gutter-b">
            ...
            <div class="col-6">
                <a href="#" class="btn btn-block btn-light btn-hover-primary text-dark-50 text-center py-10 px-5">
                    <span class="svg-icon svg-icon-3x svg-icon-primary m-0">
                        {{ AdminPanel::getSVG("media/svg/icons/Design/Color-profile.svg", "svg-icon-xl") }}
                    </span>
            ...
            <div class="col-6">
                <a href="#" class="btn btn-block btn-light btn-hover-primary text-dark-50 text-center py-10 px-5">
                    <span class="svg-icon svg-icon-3x svg-icon-primary m-0">
                        {{ AdminPanel::getSVG("media/svg/icons/Communication/Group.svg", "svg-icon-xl") }}
                    </span>
